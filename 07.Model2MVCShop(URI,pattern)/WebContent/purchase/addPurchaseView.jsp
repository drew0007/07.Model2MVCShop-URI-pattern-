...
function fncAddPurchase() {
	...
	for(i=1; i<=listSize; i++){
		prodNoList += document.getElementById("prodNo"+i).value + ",";
		tranCntList += document.getElementById("tranCnt"+i).value + ",";
	}
	
	document.getElementById("prodNoList").value = prodNoList;
	document.getElementById("tranCntList").value = tranCntList;
...
<table width="1000" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;" align="center">
	...
	<input type="hidden" name="prodNo" id="prodNo${i}" value="${cart.cartProd.prodNo}" />
	<tr class="ct_list_pop">
		...
		<td align="center">
			${cart.cartCnt}
			<input type="hidden" name="tranCnt" id="tranCnt${i}" value="${cart.cartCnt}"/>
		</td>
		<td></td>
